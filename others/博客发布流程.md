...
{
  "title": "博客发布流程",
  "description": "使用quartz发布obsidian到githubpage",
  "dg-publish": true,
  "dg-path": null,
  "date": "2024-03-22 15:43:38",
  "updated": "2024-11-21 16:29:58",
  "pin": false,
  "tags": [
    "guide"
  ],
...
3. 跟之前的步骤一样，在github初始化**另一个空的仓库**, 用于上传你的obsidian笔记，假如叫`content_demo`[^2]
	...
	![20240322-publish_init_content.png](img/user/9900_repository/20240322-publish_init_content.png)
### 配置submodule
